...
export function RegisterForm() {
  ...
  return (
    <div className="space-y-10">
      ...
      {/* Social Register — UI đầy đủ, chờ kết nối OAuth */}
      ...
      <form action={action} className="space-y-4">
        ...
        <div className="space-y-2">
          <label htmlFor="register-name" className="font-sans text-xs uppercase tracking-widest text-on-surface-variant ml-1">
            Tên hiển thị
          </label>
          <input
            id="register-name"
        ...
        <div className="space-y-2">
          <label htmlFor="register-email" className="font-sans text-xs uppercase tracking-widest text-on-surface-variant ml-1">
            Email
          </label>
          <input
            id="register-email"
        ...
        <div className="space-y-2">
          <label htmlFor="register-password" className="font-sans text-xs uppercase tracking-widest text-on-surface-variant ml-1">
            Mật khẩu
          </label>
          <div className="relative">
            <input
